...
# Custom CSS to add space between the logo and the rest of the sidebar content
logo_style = """
    <style>
    .block-container {
        padding-top: 20px; /* Adjust this value for spacing */
    }
    .sidebar-content img {
        display: block;
        margin-left: auto;
...
# Sidebar section
with st.sidebar:
    # Add logo at the top with space below it
