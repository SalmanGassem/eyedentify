...
# Custom CSS for adding margin and adjusting sidebar layout
logo_style = """
    <style>
    .sidebar .logo-container {
        margin-bottom: 40px; /* Space between logo and other sidebar elements */
    }
    </style>
"""
...
# Sidebar section
with st.sidebar:
    # Adding a div to control logo layout
