...
# Custom CSS to add margin above the page buttons in the sidebar
page_buttons_style = """
    <style>
    .css-1d391kg, .css-1dp5vir {
        margin-top: 40px;  /* Adjust the top margin to create space between the logo and the page buttons */
    }
    </style>
"""
st.markdown(page_buttons_style, unsafe_allow_html=True)
